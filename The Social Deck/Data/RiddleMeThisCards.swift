...
let allRiddleMeThisCards: [Card] = [
    ...
    Card(text: "I have a heart that doesn't beat. What am I?", category: "Classic", correctAnswer: "An artichoke"),
    Card(text: "I have legs but can't walk. What am I?", category: "Classic", correctAnswer: "A table"),
    ...
    Card(text: "I can be cracked, made, told, and played. What am I?", category: "Classic", correctAnswer: "A joke"),
    ...
    Card(text: "What has a thumb and four fingers but is not alive?", category: "Logic", correctAnswer: "A glove"),
    Card(text: "What can run but never walks, has a mouth but never talks?", category: "Logic", correctAnswer: "A river"),
    Card(text: "What has one eye but can't see?", category: "Logic", correctAnswer: "A needle"),
    Card(text: "What has many keys but can't open a single lock?", category: "Logic", correctAnswer: "A piano"),
    Card(text: "What has a spine but no bones?", category: "Logic", correctAnswer: "A book"),
    Card(text: "What has a neck but no head?", category: "Logic", correctAnswer: "A bottle"),
    Card(text: "What has hands but can't clap?", category: "Logic", correctAnswer: "A clock"),
    Card(text: "What has a face and two hands but no arms or legs?", category: "Logic", correctAnswer: "A clock"),
    Card(text: "What can you catch but not throw?", category: "Logic", correctAnswer: "A cold"),
    Card(text: "What has legs but doesn't walk?", category: "Logic", correctAnswer: "A table"),
    Card(text: "What has a head and a tail but no body?", category: "Logic", correctAnswer: "A coin"),
    ...
    Card(text: "What can you break without touching it?", category: "Wordplay", correctAnswer: "A promise"),
    Card(text: "What has a bottom at the top?", category: "Wordplay", correctAnswer: "Legs"),
    ...
    Card(text: "What has 13 hearts but no other organs?", category: "Wordplay", correctAnswer: "A deck of cards"),
    ...
    Card(text: "What has a neck but no head?", category: "Wordplay", correctAnswer: "A bottle"),
    Card(text: "What has hands but can't clap?", category: "Wordplay", correctAnswer: "A clock"),
    Card(text: "What has a face but can't see?", category: "Wordplay", correctAnswer: "A clock"),
    Card(text: "What has one eye but can't see?", category: "Wordplay", correctAnswer: "A needle"),
    ...
    Card(text: "I have a ring but no finger. What am I?", category: "Mystery", correctAnswer: "A telephone"),
    Card(text: "I have an eye but can't see. What am I?", category: "Mystery", correctAnswer: "A needle"),
    Card(text: "I have a spine but no bones. What am I?", category: "Mystery", correctAnswer: "A book"),
    Card(text: "I have a neck but no head. What am I?", category: "Mystery", correctAnswer: "A bottle"),
    Card(text: "The more you take, the more you leave behind. What am I?", category: "Logic", correctAnswer: "Footsteps"),
    Card(text: "I'm not alive but I grow. I don't have lungs but I need air. What am I?", category: "Logic", correctAnswer: "Fire"),
    Card(text: "I'm light as a feather yet the strongest can't hold me long. What am I?", category: "Logic", correctAnswer: "Breath"),
    Card(text: "I can run but never walk. I have a mouth but never talk. What am I?", category: "Logic", correctAnswer: "A river"),
    Card(text: "I have hands but can't clap. What am I?", category: "Logic", correctAnswer: "A clock"),
    Card(text: "I'm tall when I'm young, short when I'm old. What am I?", category: "Logic", correctAnswer: "A candle"),
    ...
    Card(text: "I'm always in front of you but can't be seen. What am I?", category: "Logic", correctAnswer: "The future"),
    Card(text: "What has a head, a tail, is brown, and has no legs?", category: "Classic", correctAnswer: "A penny"),
    Card(text: "What can you hold without ever touching it?", category: "Classic", correctAnswer: "A conversation"),
    Card(text: "What has one eye but can't see?", category: "Classic", correctAnswer: "A needle"),
    Card(text: "What has many teeth but can't bite?", category: "Classic", correctAnswer: "A comb"),
    Card(text: "What has hands but can't clap?", category: "Classic", correctAnswer: "A clock"),
    Card(text: "What has a face but can't see?", category: "Classic", correctAnswer: "A clock"),
    Card(text: "What has a neck but no head?", category: "Classic", correctAnswer: "A bottle"),
    Card(text: "What has a ring but no finger?", category: "Classic", correctAnswer: "A telephone"),
    Card(text: "What has a thumb and four fingers but is not alive?", category: "Classic", correctAnswer: "A glove"),
    Card(text: "What has a spine but no bones?", category: "Classic", correctAnswer: "A book"),
    Card(text: "What can you catch but not throw?", category: "Classic", correctAnswer: "A cold"),
    Card(text: "What has legs but doesn't walk?", category: "Classic", correctAnswer: "A table"),
    Card(text: "What gets wetter the more it dries?", category: "Classic", correctAnswer: "A towel"),
