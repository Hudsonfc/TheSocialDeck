...
struct ScienceTriviaPlayView: View {
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: ScienceTriviaEndView(manager: manager, deck: deck, selectedCategories: selectedCategories),
