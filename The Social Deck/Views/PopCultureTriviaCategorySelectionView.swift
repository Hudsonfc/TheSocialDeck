//
//  PopCultureTriviaCategorySelectionView.swift
//  The Social Deck
//
...
struct PopCultureTriviaCategorySelectionView: View {
    let deck: Deck
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: PopCultureTriviaSetupView(deck: deck, selectedCategories: selectedCategory != nil ? [selectedCategory!] : []),
