//
//  CategoryClashLoadingView.swift
//  The Social Deck
//
...
struct CategoryClashLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: CategoryClashPlayView(
                    manager: CategoryClashGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount, timerEnabled: timerEnabled, timerDuration: timerDuration),
                    deck: deck,
