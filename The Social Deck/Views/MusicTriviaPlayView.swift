...
struct MusicTriviaPlayView: View {
    @ObservedObject var manager: MusicTriviaGameManager
    let deck: Deck
    ...
    var body: some View {
        ...
        .background(
            Group {
                NavigationLink(
                    destination: MusicTriviaEndView(manager: manager, deck: deck, selectedCategories: selectedCategories),
