...
struct MovieTriviaPlayView: View {
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: MovieTriviaEndView(manager: manager, deck: deck, selectedCategories: selectedCategories),
