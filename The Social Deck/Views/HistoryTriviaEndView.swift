...
struct HistoryTriviaEndView: View {
    @ObservedObject var manager: HistoryTriviaGameManager
    let deck: Deck
    ...
    var scorePercentage: Int {
        ...
        let percentage = (Double(score) / Double(cardCount)) * 100.0
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: HistoryTriviaCategorySelectionView(deck: deck),
