//
//  CloserThanEverLoadingView.swift
//  The Social Deck
//
...
struct CloserThanEverLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: CloserThanEverPlayView(
                    manager: CloserThanEverGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
