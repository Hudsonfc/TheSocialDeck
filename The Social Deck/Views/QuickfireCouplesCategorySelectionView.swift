...
struct QuickfireCouplesCategorySelectionView: View {
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: QuickfireCouplesSetupView(deck: deck, selectedCategories: Array(selectedCategories)),
...
#Preview {
    NavigationView {
        QuickfireCouplesCategorySelectionView(deck: Deck(
            ...
            cards: [],
            availableCategories: ["Light & Fun", "Preferences", "Personality", "Date Ideas", "Relationship"]
        ))
    }
}
