...
struct BluffCallLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: BluffCallPlayView(
                    manager: BluffCallGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount, players: players),
                    deck: deck,
