//
//  HistoryTriviaLoadingView.swift
//  The Social Deck
//
...
struct HistoryTriviaLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: HistoryTriviaPlayView(
                    manager: HistoryTriviaGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
