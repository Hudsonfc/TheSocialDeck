...
struct QuickfireCouplesPlayView: View {
    @ObservedObject var manager: QuickfireCouplesGameManager
    let deck: Deck
...
struct QuickfireCouplesCardBackView: View {
    let optionA: String
    let optionB: String
...
#Preview {
    NavigationView {
        QuickfireCouplesPlayView(
            manager: QuickfireCouplesGameManager(
                deck: Deck(
                    ...
                    availableCategories: ["Light & Fun", "Preferences"]
                ),
