//
//  PopCultureTriviaLoadingView.swift
//  The Social Deck
//
...
struct PopCultureTriviaLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: PopCultureTriviaPlayView(
                    manager: PopCultureTriviaGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
