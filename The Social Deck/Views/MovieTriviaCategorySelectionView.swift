//
//  MovieTriviaCategorySelectionView.swift
//  The Social Deck
//
...
struct MovieTriviaCategorySelectionView: View {
    let deck: Deck
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: MovieTriviaSetupView(deck: deck, selectedCategories: selectedCategory != nil ? [selectedCategory!] : []),
