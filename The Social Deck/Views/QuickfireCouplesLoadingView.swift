//
//  QuickfireCouplesLoadingView.swift
//  The Social Deck
//
...
struct QuickfireCouplesLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: QuickfireCouplesPlayView(
                    manager: QuickfireCouplesGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
