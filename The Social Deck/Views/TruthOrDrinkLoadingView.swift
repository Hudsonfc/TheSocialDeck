...
struct TruthOrDrinkLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: TruthOrDrinkPlayView(
                    manager: TruthOrDrinkGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
