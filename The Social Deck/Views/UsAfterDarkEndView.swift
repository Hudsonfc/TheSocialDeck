...
struct UsAfterDarkEndView: View {
    let deck: Deck
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 12) {
                        Text("Beautiful Conversation")
                            .font(.system(size: 32, weight: .bold, design: .rounded))
                            .foregroundColor(.primaryText)
                        
                        Text("Hope you feel closer and more connected!")
                    ...
                    // Game summary
                    VStack(spacing: 16) {
                        summaryRow(label: "Questions Discussed", value: "\(cardsPlayed)")
                    }
                    .padding(20)
