//
//  TruthOrDrinkCategorySelectionView.swift
//  The Social Deck
//
...
struct TruthOrDrinkCategorySelectionView: View {
    let deck: Deck
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: TruthOrDrinkSetupView(deck: deck, selectedCategories: Array(selectedCategories)),
