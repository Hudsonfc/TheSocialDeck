...
struct MusicTriviaLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: MusicTriviaPlayView(
                    manager: MusicTriviaGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
