//
//  MusicTriviaCategorySelectionView.swift
//  The Social Deck
//
...
struct MusicTriviaCategorySelectionView: View {
    let deck: Deck
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(
                destination: MusicTriviaSetupView(deck: deck, selectedCategories: selectedCategory != nil ? [selectedCategory!] : []),
