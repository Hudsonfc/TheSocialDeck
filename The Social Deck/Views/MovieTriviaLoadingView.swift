...
struct MovieTriviaLoadingView: View {
    let deck: Deck
        ...
        .background(
            NavigationLink(
                destination: MovieTriviaPlayView(
                    manager: MovieTriviaGameManager(deck: deck, selectedCategories: selectedCategories, cardCount: cardCount),
                    deck: deck,
